function OurCollection() {
  return (
    <div className="mt-28 text-center sm:pb-28">
      <h2 className=" mb-8 inline-block bg-gradient-to-b from-grey-grey to-light-cream bg-clip-text text-h2 font-bold text-transparent sm:absolute sm:flex sm:text-h1 md:text-[120px] lg:text-[160px] xl:text-[220px] 2xl:text-[260px]">
        our collection
      </h2>
      <div className=" sm:relative sm:grid sm:grid-cols-2 sm:pl-10 sm:pr-10 sm:pt-28 lg:grid lg:grid-cols-4 lg:grid-rows-1  lg:pr-0 lg:pt-40 xl:pt-56 2xl:pt-64">
