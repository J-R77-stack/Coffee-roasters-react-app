...
function Plan() {
  return (
    <>
      <div className="grid grid-rows-2 rounded-xl bg-[url('/src/images/mobile/image-hero-blackcup.jpg')] bg-cover bg-center bg-no-repeat pb-16 pt-10 text-center sm:bg-[url('/src/images/tablet/image-hero-blackcup.jpg')] sm:pl-6 sm:text-left">
        <h2 className="mt-20 pl-3 pr-3 text-h2 font-bold leading-h2 text-light-cream">
          Create a plan
        </h2>
        <p className="mt-4 pb-10 pl-4 pr-4 font-barlow text-body leading-body text-grey-grey sm:pr-52">
          Build a subscription plan that best fits your needs. We offer an
          assortment of the best artisan coffees from around the globe delivered
          fresh to your door.
        </p>
      </div>
      <div className="mt-16 h-[1100px] rounded-xl bg-[url('/src/images/mobile/bg-steps.png')] bg-cover bg-center bg-no-repeat sm:h-[610px] sm:bg-[url('/src/images/tablet/bg-steps.png')]">
        <div className="hidden sm:flex sm:pl-8 sm:pt-20 lg:pl-[2rem] lg:pt-10">
          <div className="sm:flex">
            <div className="rounded-full border-2 border-solid border-dark-cyan sm:h-11 sm:w-11 "></div>
            <div>
              <hr className="border-2 border-solid border-pale-orange sm:mt-5 sm:w-40 lg:w-[15rem]" />
            </div>
          </div>
          <div className="sm:flex">
            <div className="rounded-full border-2 border-solid border-dark-cyan sm:h-11 sm:w-11"></div>
