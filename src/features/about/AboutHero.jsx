function AboutHero() {
  return (
    <>
      <div className="grid grid-rows-2 rounded-xl  bg-[url('/src/images/mobile/image-hero-whitecup.jpg')] bg-cover bg-center bg-no-repeat p-4 pb-16 pt-12 text-center sm:bg-[url('/src/images/tablet/image-hero-whitecup.jpg')] sm:p-8 sm:text-left">
        <h3 className="mt-20 text-h3 font-bold leading-h3 text-light-cream sm:mb-8">
          About us
        </h3>
        <p className="font-barlow text-body leading-body text-light-cream  sm:pr-40">
      ...
      <div className="sm:grid sm:grid-cols-2">
        <div className=" mt-32 h-96 rounded-xl bg-[url('/src/images/mobile/image-commitment.jpg')] bg-cover bg-center bg-no-repeat sm:h-[560px] sm:bg-[url('/src/images/tablet/image-commitment.jpg')]"></div>
        <div className="sm:ml-10">
          <h3 className="mt-20 text-center text-h3 font-bold leading-h3 text-black sm:mt-36 sm:text-left">
            Our commitment
          </h3>
      ...
      <div className="grid h-[600px] place-content-center rounded-xl bg-[url('/src/images/mobile/bg-quality.png')] bg-cover bg-center bg-no-repeat sm:mt-[80px] sm:h-[660px] sm:bg-[url('/src/images/tablet/bg-quality.png')]">
        <div className="mb-10 ml-10 h-[150px] w-64 rounded-xl bg-[url('/src/images/mobile/image-quality.jpg')] bg-cover bg-center bg-no-repeat  sm:h-[300px] sm:w-[600px] sm:bg-[url('/src/images/tablet/image-quality.jpg')]"></div>
