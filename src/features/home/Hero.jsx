function Hero() {
  return (
    <div className="  grid grid-rows-3 rounded-xl bg-[url('/src/images/mobile/image-hero-coffeepress.jpg')] bg-cover bg-center bg-no-repeat p-4  pb-10 pt-12 text-center sm:bg-[url('/src/images/tablet/image-hero-coffeepress.jpg')] sm:pl-10 sm:pr-32 sm:text-left lg:bg-[url('/src/images/desktop/image-hero-coffeepress.jpg')] lg:pb-0">
      <h1 className="mt-12 text-h2 font-bold leading-h2 text-light-cream sm:pr-28 lg:mt-16 lg:pl-4 lg:pr-[10rem] lg:text-[72px] lg:leading-[72px] lg:tracking-wider">
        Great coffee made simple.
      </h1>

      <span className=" px-1 pt-4 font-barlow text-body leading-body text-grey-grey sm:pt-9  md:pr-24 lg:pb-0 lg:pl-4 lg:pr-[18rem]">
