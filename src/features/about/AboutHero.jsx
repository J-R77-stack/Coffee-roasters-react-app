function AboutHero() {
  return (
    <>
      <div className="grid grid-rows-2 rounded-xl  bg-cover bg-center bg-no-repeat p-4 pb-16 pt-12 text-center sm:bg-[url('/src/images/tablet/image-hero-whitecup.jpg')] sm:p-8 sm:text-left">
