  ...
  return (
    <div className="item relative flex w-[340px] flex-col items-center rounded-xl  sm:w-full">
      ...
      {isOpen && (
        ...
        >
          <button className="rounded-xl bg-zinc-200 p-5 text-left hover:bg-pale-orange active:bg-dark-cyan sm:h-[240px] ">
            <h4 className="pb-2 text-h4 font-bold text-black">
              {props.option1}
            </h4>
            <p className="font-barlow text-body leading-body">{props.info1}</p>
          </button>
          <button className="mt-5 rounded-xl bg-zinc-200 p-5 text-left hover:bg-pale-orange active:bg-dark-cyan sm:mt-0 ">
            <h4 className="pb-2 text-h4 font-bold text-black">
              {props.option2}
            </h4>
